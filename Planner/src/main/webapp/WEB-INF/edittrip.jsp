...
<body>
	...
	<main class="bg">
		...
		<form:form action="/trip/${trip.id}/edit" method="put" modelAttribute="trip" class="form2">
		<form:hidden path="user" value="${user_id}"/>
		    ...
		    <div class="col-med-6" style="margin-top:20px;">
	    		...
	    		<input style="margin-top: 20px; margin-left: 225px" type="submit" value="Update" class="createnew" style="margin-left: 370px;"/>
		</form:form>  
		</div>
	</main>
</body>
